angular.module("beam.perdiaAPVCCDvlDrilldown", [
    'ui.router', 'ui.bootstrap'
])

.config(function ($stateProvider) {
    $stateProvider.state('perdiaAPVCCDvlDrilldown', {
        url: '/perdiaAPVCCDvlDrilldown',
        views: {
            "main": {
                controller: 'PerdiaAPVCCDvlDrilldownController as model',
                templateUrl: 'perdiaAPVCCDvlDrilldown/perdiaAPVCCDvlDrilldown.tpl.html'
            }
        },
        data:{ pageTitle: 'Perdia VCCD VL Drilldown' }
    });
})

.controller('PerdiaAPVCCDvlDrilldownController', [ '$scope', '$location', 'DiagramHeaders', function PerdiaAPVCCDvlDrilldownController($scope, $location, DiagramHeaders) {
