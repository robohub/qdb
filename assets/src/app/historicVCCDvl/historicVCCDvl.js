angular.module("beam.historicVCCDvl", [
    'ui.router', 'ui.bootstrap'
])

.config(function ($stateProvider) {
    $stateProvider.state('historicVCCDvl', {
        url: '/historicVCCDvl',
        views: {
            "main": {
                controller: 'HistoricVCCDvlController as model',
                templateUrl: 'historicVCCDvl/historicVCCDvl.tpl.html'
            }
        },
        data:{ pageTitle: 'Historic VCT VL Drilldown' }
    });
})

.controller('HistoricVCCDvlController', [ '$scope', '$location', 'DiagramHeaders', function HistoricVCCDvlController($scope, $location, DiagramHeaders) {
