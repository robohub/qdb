angular.module("beam.historicVCGvl", [
    'ui.router', 'ui.bootstrap'
])

.config(function ($stateProvider) {
    $stateProvider.state('historicVCGvl', {
        url: '/historicVCGvl',
        views: {
            "main": {
                controller: 'HistoricVCGvlController as model',
                templateUrl: 'historicVCGvl/historicVCGvl.tpl.html'
            }
        },
        data:{ pageTitle: 'Historic VCG VL Drilldown' }
    });
})

.controller('HistoricVCGvlController', [ '$scope', '$location', 'DiagramHeaders', function HistoricVCGvlController($scope, $location, DiagramHeaders) {
