angular.module("beam.perdiaAPVCGvlDrilldown", [
    'ui.router', 'ui.bootstrap'
])

.config(function ($stateProvider) {
    $stateProvider.state('perdiaAPVCGvlDrilldown', {
        url: '/perdiaAPVCGvlDrilldown',
        views: {
            "main": {
                controller: 'PerdiaAPVCGvlDrilldownController as model',
                templateUrl: 'perdiaAPVCGvlDrilldown/perdiaAPVCGvlDrilldown.tpl.html'
            }
        },
        data:{ pageTitle: 'Perdia VCG VL Drilldown' }
    });
})

.controller('PerdiaAPVCGvlDrilldownController', [ '$scope', '$location', 'DiagramHeaders', function PerdiaAPVCGvlDrilldownController($scope, $location, DiagramHeaders) {
